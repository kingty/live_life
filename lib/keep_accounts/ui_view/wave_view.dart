            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: KeepAccountsTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      KeepAccountsTheme.nearlyDarkBlue.withOpacity(0.2),
                      KeepAccountsTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      KeepAccountsTheme.nearlyDarkBlue.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: KeepAccountsTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: KeepAccountsTheme.white.withOpacity(
