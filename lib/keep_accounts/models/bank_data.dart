...
class BankData {
  ...
  static BankData? getByKey(String key) {
    for (var value in banks) {
  ...
  static Map<String, BankData> network = <String, BankData>{  "OTHERW": BankData(
                             key: 'OTHERW',
                             name: '其他账户',
                             logo: 'assets/keep_accounts/bank/network/OTHERW.png',
                             mainColor: const Color.fromRGBO(250, 143, 47, 1.0)
                            ), 
  "QQW": BankData(
                             key: 'QQW',
                             name: 'QQ钱包',
                             logo: 'assets/keep_accounts/bank/network/QQW.png',
                             mainColor: const Color.fromRGBO(235, 28, 38, 1.0)
                            ), 
  "WXW": BankData(
                             key: 'WXW',
                             name: '微信钱包',
                             logo: 'assets/keep_accounts/bank/network/WXW.png',
                             mainColor: const Color.fromRGBO(9, 187, 7, 1.0)
                            ), 
  "ZFBW": BankData(
                             key: 'ZFBW',
                             name: '支付宝',
                             logo: 'assets/keep_accounts/bank/network/ZFBW.png',
                             mainColor: const Color.fromRGBO(2, 169, 241, 1.0)
                            ), 
  "JDW": BankData(
                             key: 'JDW',
                             name: '京东',
                             logo: 'assets/keep_accounts/bank/network/JDW.png',
                             mainColor: const Color.fromRGBO(225, 35, 25, 1.0)
                            ), 
  "CASHW": BankData(
                             key: 'CASHW',
                             name: '现金钱包',
                             logo: 'assets/keep_accounts/bank/network/CASHW.png',
                             mainColor: const Color.fromRGBO(74, 144, 226, 1.0)
                            )
};  static Map<String, BankData> cssyyh = <String, BankData>{  "MTBANK": BankData(
                             key: 'MTBANK',
                             name: '浙江民泰商业银行',
...
};  static Map<String, BankData> gfzsyyh = <String, BankData>{  "CMBC": BankData(
                             key: 'CMBC',
                             name: '中国民生银行',
...
};  static Map<String, BankData> gydxsyyh = <String, BankData>{  "CCB": BankData(
                             key: 'CCB',
                             name: '建设银行',
...
};  static Map<String, BankData> wzfryh = <String, BankData>{  "BOSH": BankData(
                             key: 'BOSH',
                             name: '新韩银行',
